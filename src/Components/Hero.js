  ...
  return (
        <section className='mt-1'>
            ...
            <div className='md:max-w-[85rem] md:mx-auto md:px-1 '>
                ...
                <div className=' h-[500px] sm:h-[400px] lg:h-[500px] xl:h-[600px] 2xl:h-[700px] '>
                    <img src="https://robbreport.com/wp-content/uploads/2021/04/todd-snyder-footjoy-1.jpg" class="w-full h-full object-cover"/>

                    <div className='flex flex-col absolute top-1/4 left-0 right-0 mt-12 lg:mt-3 items-center'>
